...
public class afterLogin extends BaseTest {
    ...
    public void AddUser() throws InterruptedException {
        ...
        Thread.sleep(3000);
        driver.findElement(By.id("nameWallet")).sendKeys("Test casee 11");
        driver.findElement(By.id("emailIDWallet")).sendKeys("testcc11@yopmail.com");
        driver.findElement(By.id("mobile_number")).sendKeys("9999905561");
        ...
        driver1 = new ChromeDriver(options);
        driver1.navigate().to("https://yopmail.com/");
        driver1.findElement(By.xpath("//input[@placeholder='Enter your inbox here']")).sendKeys("testcc11@yopmail.com");
        Thread.sleep(25000);
        driver1.findElement(By.xpath("//i[@class='material-icons-outlined f36']")).click();
        Thread.sleep(5000);
        WebElement iframe = driver1.findElement(By.xpath("//iframe[@id='ifmail']"));
    ...
    public void basicInformation() throws InterruptedException {
        ...
        inputElement2.clear();
        Thread.sleep(3000);
        inputElement2.sendKeys("Triptiiiiiiii");
