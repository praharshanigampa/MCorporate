...
public class Signup extends BaseTest {
    ...
    public void Signup() throws InterruptedException {
        ...
        Thread.sleep(3000);
        driver.findElement(By.xpath("//input[@id='name']")).sendKeys("developer31");
        driver.findElement(By.xpath("//input[@id='companyName']")).sendKeys("developer31");
        driver.findElement(By.xpath("//input[@id='email']")).sendKeys("developer31@yopmail.com");
        driver.findElement(By.xpath("//input[@id='confirm_email']")).sendKeys("developer31@yopmail.com");
        driver.findElement(By.xpath("//input[@id='mob_no']")).sendKeys("9999900031");
        ...
        driver1.findElement(By.xpath("//input[@placeholder='Enter your inbox here']")).sendKeys("developer31");
        Thread.sleep(25000);
