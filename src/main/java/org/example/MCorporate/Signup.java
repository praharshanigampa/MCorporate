...
public class Signup extends BaseTest {
    ...
    public void Signup() throws InterruptedException {
        ...
        Thread.sleep(3000);
        driver.findElement(By.xpath("//input[@id='name']")).sendKeys("developer26");
        driver.findElement(By.xpath("//input[@id='companyName']")).sendKeys("developer26");
        driver.findElement(By.xpath("//input[@id='email']")).sendKeys("developer26@yopmail.com");
        driver.findElement(By.xpath("//input[@id='confirm_email']")).sendKeys("developer26@yopmail.com");
        ...
        driver1.findElement(By.xpath("//input[@placeholder='Enter your inbox here']")).sendKeys("developer26");
        Thread.sleep(25000);
