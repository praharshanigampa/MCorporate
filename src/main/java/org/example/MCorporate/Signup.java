...
public class Signup extends BaseTest {
    ...
    public void Signup() throws InterruptedException, AWTException {
        ...
        Thread.sleep(3000);
        driver.findElement(By.xpath("//input[@id='name']")).sendKeys("developer48");
        driver.findElement(By.xpath("//input[@id='companyName']")).sendKeys("developer48");
        driver.findElement(By.xpath("//input[@id='email']")).sendKeys("developer48@yopmail.com");
        driver.findElement(By.xpath("//input[@id='confirm_email']")).sendKeys("developer48@yopmail.com");
        driver.findElement(By.xpath("//input[@id='mob_no']")).sendKeys("9999900048");
        ...
        driver1.findElement(By.xpath("//input[@placeholder='Enter your inbox here']")).sendKeys("developer48");
        Thread.sleep(25000);
