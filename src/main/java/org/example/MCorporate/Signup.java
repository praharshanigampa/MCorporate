...
public class Signup extends BaseTest {
    ...
    public void Signup() throws InterruptedException, AWTException {
        ...
        Thread.sleep(3000);
        driver.findElement(By.xpath("//input[@id='name']")).sendKeys("developer47");
        driver.findElement(By.xpath("//input[@id='companyName']")).sendKeys("developer47");
        driver.findElement(By.xpath("//input[@id='email']")).sendKeys("developer47@yopmail.com");
        driver.findElement(By.xpath("//input[@id='confirm_email']")).sendKeys("developer47@yopmail.com");
        driver.findElement(By.xpath("//input[@id='mob_no']")).sendKeys("9999900047");
        ...
        driver1.findElement(By.xpath("//input[@placeholder='Enter your inbox here']")).sendKeys("developer47");
        Thread.sleep(25000);
